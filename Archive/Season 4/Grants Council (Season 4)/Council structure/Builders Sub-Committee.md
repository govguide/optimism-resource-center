...
> To view the source, please click [here](https://app.charmverse.io/op-grants/page-13972604474186334).
...
- [Kaereste](https://gov.optimism.io/u/kaereste/summary)
    
- [Jack Anorak](https://gov.optimism.io/u/jackanorak/summary)
    

## Sub-Committee Authorization

The following summarizes the basic budget and parameters of the Sub-Committee, as provided for by the [Token House vote](https://snapshot.org/#/opcollective.eth/proposal/0x37fc8a6ae60cff2e4e72fe9c0567f739bb9a78262c2ada236892fcbc7af2c32d).

- **Budget**: 1MM OP across all grants for Season 4
    
- **Grant Size**: <50k OP per grant
    
- **Grant Lockup**: 1 year ([see explainer here](https://gov.optimism.io/t/grant-token-lock-explainer/5060))
    
- **Support**: Successful grants require 2/3 Sub-Committee members to adopt a proposal or approve an action
